<div class="wrapper">
	...
	<?php $this->load->view('sistem/_partials/navbar'); ?>
	...
	<aside class="main-sidebar">
		<section class="sidebar">
			...
			<?php $this->load->view('sistem/_partials/sidemenu'); ?>
		</section>
	</aside>
	...
	<div class="content-wrapper">
		<section class="content-header">
			...
			<?php $this->load->view('sistem/_partials/breadcrumb'); ?>
		</section>
		<section class="content">
			<?php $this->load->view($inner_view); ?>
			<?php $this->load->view('sistem/_partials/back_btn'); ?>
		</section>
	</div>

	<?php // Footer ?>
	<?php $this->load->view('sistem/_partials/footer'); ?>
